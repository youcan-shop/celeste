...
<template>
  <td
    :class="clsx('celeste-table-cell', props.class, {
      'celeste-table-cell-align-end': props.end,
    })"
  >
    <slot />
  </td>
